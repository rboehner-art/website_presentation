        ...
        <header class="mainHeader">
            ...
            <div class="container-fluid h-100">
                <div class="row h-100 align-items-center justify-content-center text-center text-white" style="background-color:rgba(0,0,0,0.2);">
                    <div class="col-lg-8">
                            <h1 class="display-1 font weight-bold">Notorious<span class="font-weight-light"> R.D.B</span></h1>
                            <hr class="bg-white my-5"/>
                           
                            <p> I have a bad feeling about this.
    
                                </p>
                        <a href="#about" class="btn btn-primary btn-lg mt-3">Like and Subscribe</a>
                    </div>
                </div>
            </div>
